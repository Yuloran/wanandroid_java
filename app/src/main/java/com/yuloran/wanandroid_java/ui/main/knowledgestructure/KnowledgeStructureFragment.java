 ...
 */
package com.yuloran.wanandroid_java.ui.main.knowledgestructure;
...
{
    private static final String TAG = "KnowledgeStructureFragment";
            ...
            savedInstanceState)
    {
        ...
        textView.setText(TabConfig.Tab.KNOWLEDGE_STRUCTURE.getTitle());
        return root;
    }
}
